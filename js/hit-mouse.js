...
function showText() {
    ...
    document.getElementsByClassName('text-content')[0].style.backgroundImage = 'url(' + article[currentIndex].imgUrl + ')';
    if (currentIndex < 9) {
        currentIndex++;
    }else {
        currentIndex = 10
